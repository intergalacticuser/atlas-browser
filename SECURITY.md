...
If you discover a security vulnerability in Atlasiant Browser, **please report it responsibly**.

Email: intergalacticuser@users.noreply.github.com

Or open a [GitHub issue](https://github.com/intergalacticuser/atlasiant-browser/issues) with the `security` label.
