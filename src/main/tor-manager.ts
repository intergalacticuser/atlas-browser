 ...
 * Angle Browser prioritizes honest disclosure over marketing claims.
 */
export class TorManager {
  ...
  async getCircuitInfo(): Promise<{ nodes: string[]; isActive: boolean; disclaimer: string }> {
    ...
    return {
      ...
      nodes: [
        'Your Device',
        'Angle Server (encrypted tunnel)',
        'Tor Network (3 hops)',
        'Destination',
      ],
      disclaimer: 'Privacy proxy via Angle server → Tor. For full Tor anonymity, use Tor Browser.',
    };
  }
}
